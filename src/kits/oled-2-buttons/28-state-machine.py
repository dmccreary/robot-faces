...
#
# 5. Count the states you could add before the tables get hard to read.
#    Then imagine writing the same thing as nested if-statements. That gap
#    is why state machines are worth knowing.

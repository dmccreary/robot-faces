...
def rotary_changed(change):
    global rotary_val, fill_indicator
...
def update_display(counter, rotary_val, fill_indicator):
    oled.fill(0)
...
counter = 0
while True:
    update_display(counter, rotary_val, fill_indicator)
    led.toggle()
    sleep(.1)
    counter += 1
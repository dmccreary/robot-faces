...
![Simulated output of 23-face-module.py](sample-output.png)
...
!!! mascot-thinking "Worth Thinking About"
    ...
    Once you've named the parts — eyes, eyebrows, a mouth — you stop thinking in pixels and start thinking in faces. That's the whole trick behind every emotion this kit can draw.

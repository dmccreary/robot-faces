# Learning Graph for Robot Faces
...
four pioneering commercial robots covered in chapter 2 [History of Robot Faces](../chapters/02-history-of-robot-faces/index.md)
...
the first stable release to include them, v1.20.0).
...
- Graph structure validation - all 293 concepts are connected in a single component
- DAG validation (no cycles detected)
- Foundational concepts: 14 entry points
